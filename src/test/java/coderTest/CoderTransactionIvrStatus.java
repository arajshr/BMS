...
public class CoderTransactionIvrStatus extends BrowserInitiated {
  @Test
  
	  public void IvrCoderTrans() throws Exception
	  		{
		  	
		  	int execuatbleRowId = excel.isExecutable("IvrCoderTrans");
			...
			objCoderTransStatus.click_CodingMenu()
								.click_InboxTab()
								.click_codingInbox();
			objCoderTransStatus.CoderTransIvr(Location,TotalCodedCharts,  TotalPendedCharts,  DiscardedChart, CoderInitials, DuplciateCharts , ViewCharge, CoderComment);
