...
public class CoderTransactionIncompleteStatus extends BrowserInitiated {
  @Test
  
	  public void InCompleteCoderTrans() throws Exception {
		  
		  int execuatbleRowId = excel.isExecutable("InCompleteCoderTrans");
			...
			objCoderTransStatus.click_CodingMenu()
								.click_InboxTab()
								.click_codingInbox();
			objCoderTransStatus.CoderTransIncomplete(Location,TotalCodedCharts,  TotalPendedCharts,  DiscardedChart, CoderInitials, DuplciateCharts , ViewCharge, CoderComment);
